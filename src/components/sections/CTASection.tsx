  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-32 px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-20 left-1/4 w-32 h-32 bg-gradient-to-br from-blue-200/30 to-indigo-200/20 rounded-3xl rotate-45 blur-xl animate-bounce"
          style={{ animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-32 right-1/3 w-24 h-24 bg-gradient-to-br from-purple-200/25 to-pink-200/20 rounded-full blur-xl animate-bounce delay-1000"
          style={{ animationDuration: "4s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/6 w-20 h-20 bg-gradient-to-br from-emerald-200/30 to-cyan-200/20 rounded-2xl rotate-12 blur-lg animate-bounce delay-2000"
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="mb-6 md:mb-8">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full px-4 md:px-6 py-2 md:py-3 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <span className="cursor-pointer text-sm md:text-base font-medium">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed px-4">
            Join industry leaders who've accelerated their growth with our

...
import { Search, Cpu, TrendingUp, MousePointer, Percent } from "lucide-react";
import { Building2 } from "lucide-react"; // ✅ sahi
...
export default function ProcessSection() {
  return (
    <section
      id="process"
      className="relative py-12 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-slate-50/50 to-blue-50/30 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            <Badge
              variant="outline"
              className="cursor-pointer  px-3 py-1.5 md:px-4 md:py-2 bg-white/80 backdrop-blur-sm text-blue-700 border-blue-200 font-medium shadow-lg hover:shadow-xl transition-all duration-300 text-xs md:text-sm"
            >
          ...
          <p className="text-base md:text-lg lg:text-xl text-slate-600 max-w-4xl mx-auto font-light leading-relaxed px-4 md:px-0">
            We don't just identify problems - we redesign processes and build
            custom technology solutions in one seamless engagement.
            <span className="text-slate-900 font-medium block sm:inline mt-2 sm:mt-0">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="cursor-pointer grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8"
          >
            {[
              {
                ...
                description:
                  "Ex-Big 4 consultants identify root causes and design optimal processes",
                features: [
              ...
              },
              {
                ...
                description:
                  "Elite engineers create tailored ERP solutions that fit your exact needs",
                features: [
              ...
              },
              {
                ...
                description:
                  "One team ensures perfect alignment from strategy to execution",
                features: [
                  "Change Management",
                  "Training & Support",
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card
                  className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-500 h-full group rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br ${item.bgGradient} backdrop-blur-sm relative transform hover:-translate-y-1 md:hover:-translate-y-2`}
                >
        ...
        >
          <div className="text-center mb-8 md:mb-12 px-4">
            ...
            <p className="text-base md:text-lg text-slate-600 font-light max-w-2xl mx-auto leading-relaxed">
              Experience how our solutions transform business operations in
              real-time
            </p>
          </div>
              ...
              >
                ...
                <div className="space-y-3 md:space-y-4">
                  {[
                    ...
                    >
                      <h5 className="font-semibold text-slate-900 mb-1 md:mb-2 text-sm md:text-base">
                        {feature.title}
                      </h5>

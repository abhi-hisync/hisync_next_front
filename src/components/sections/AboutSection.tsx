...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="relative py-20 lg:py-32 px-4 bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50/30 overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-full text-sm font-medium text-gray-700 shadow-sm cursor-pointer hover:shadow-lg transition-all duration-300">
            <Users className="cursor-pointer w-4 h-4 text-blue-600" />
            About HISYNC
          </div>
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-light">
            We combine the strategic expertise of Big 4 consulting with the
            technical excellence of elite engineering to deliver
            enterprise-grade solutions.
          </p>
        </motion.div>

        <div className="cursor-pointer grid lg:grid-cols-3 gap-6 lg:gap-8">
          {[
            {
              title: "Ex-Big 4 Consultants",
              description:
                "Strategic minds who understand complex business challenges and enterprise transformation at scale",
            ...
            },
            {
              ...
              description:
                "Technical experts building scalable, enterprise-grade solutions with proven reliability and performance",
            ...
            },
            {
              title: "Global Reach",
              description:
                "Serving Fortune 500 companies worldwide with local expertise and international quality standards",
            ...
            >
              <div className="relative p-8 lg:p-10 h-full bg-white/90 backdrop-blur-sm border border-gray-200/60 rounded-3xl shadow-sm hover:shadow-xl hover:shadow-gray-200/40 transition-all duration-500 group-hover:bg-white group-hover:border-gray-300/60 group-hover:-translate-y-1">
                ...
                <div className="relative z-10">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-white mb-6 group-hover:scale-105 transition-all duration-300 shadow-lg shadow-${item.accent}-500/20`}
                  >
                    {item.icon}
                  </div>

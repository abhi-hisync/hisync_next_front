  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div
          className="absolute top-1/3 left-16 w-20 h-20 border-2 border-blue-200/40 rounded-full animate-bounce"
          style={{ animationDuration: "3s" }}
        />
        <div
          className="absolute bottom-1/4 right-1/3 w-24 h-24 border border-indigo-200/50 rounded-2xl rotate-45 animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-32 left-1/4 w-16 h-16 border-2 border-slate-200/60 rounded-xl rotate-12 animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "2s" }}
        />

        {/* Subtle Gradient Orbs */}
        <div
          className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-to-br from-blue-50/40 to-slate-50/30 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "6s" }}
        />
        <div
          className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-gradient-to-br from-indigo-50/30 to-blue-50/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
              ...
              <span className="text-slate-900 font-medium">One Team</span> for
                ...
                <div className="relative z-10">
                  <div
                    className={`${getIconColors(
                      service.color
                    )} mb-6 group-hover:scale-110 transition-all duration-500 group-hover:rotate-3`}
                  >
                    {service.icon}
                  </div>
                  ...
                  <Button className="w-full bg-slate-900 hover:bg-slate-800 text-white font-semibold py-3 rounded-xl transition-all duration-300 group-hover:shadow-lg hover:scale-105">
                    Learn More
            ...
            {additionalServices.map((service, index) => (
              ...
              >
                ...
                <div
                  className={`${getIconColors(
                    service.color
                  )} mb-4 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 relative z-10`}
                >
                  {service.icon}
                </div>
